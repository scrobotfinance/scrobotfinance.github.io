...
const DeFiXBotSection = () => {
  ...
  return (
    <div
      className="bg-garbi-version-2-30-white container mx-auto grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-4 sm:gap-2 overflow-hidden flex flex-row items-center justify-center py-[50px] lg:py-[120px] box-border gap-[50px] lg:gap-[160px] [&.animate]:animate-[2s_ease_0s_1_normal_forwards_fade-in] opacity-[0] text-left lg:text-21xl text-[32px] text-garbi-version-2-60-black"
      data-animate-on-scroll
    >
      <div className="img" >
        <img
